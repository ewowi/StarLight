...
//int pins[16] = {32,33,25,26,27,14,12,13,15,2,4,5,18,19,21,22}; //optionally: 0,1,3,11,23 PHYSICAL_DRIVER on esp32-wrover (PSRAM)
//int pins[16] = {22,21,19,18,5,4,2,15,13,12,14,27,26,25,33,32}; //optionally: 0,1,3,11,23 PHYSICAL_DRIVER on esp32-wrover (PSRAM)
int pins[10] = {22,21,14,18,5,4,2,27,13,12}; //optionally: 0,1,3,11,23 PHYSICAL_DRIVER on esp32-wrover (PSRAM)
