...
public:
  ...
  uint16_t processEffectNr = UINT16_MAX; //process change initiated outside library (ESK)
  uint16_t processProjectionNr = UINT16_MAX; //process change initiated outside library (ESK)
